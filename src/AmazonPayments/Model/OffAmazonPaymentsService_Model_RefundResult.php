...
class OffAmazonPaymentsService_Model_RefundResult extends OffAmazonPaymentsService_Model
{
     ...
     *
     * @param OffAmazonPaymentsService_Model_RefundDetails $value
     *
     * @return void
     */
    public function setRefundDetails(OffAmazonPaymentsService_Model_RefundDetails $value)
    {
     ...
     */
    public function withRefundDetails(OffAmazonPaymentsService_Model_RefundDetails $value)
    {
